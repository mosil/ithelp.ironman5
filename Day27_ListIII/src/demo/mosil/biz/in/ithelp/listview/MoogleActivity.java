...
//				startActivity(intent);
			...
			case R.id.menu_setting_language:
				Intent intentToSetting = new Intent(this, Moogle4Activity.class);
				startActivity(intentToSetting);
				break;
			case R.id.menu_moogle5:
				Intent intentToMoogle5 = new Intent(this, Moogle5Activity.class);
				startActivity(intentToMoogle5);
				break;
		}
